...
const ProductForm: React.FC<ProductFormProps> = ({
  ...
  const { imageUrls, setImageUrls, setNote } = useImageUploadModal()
  ...
  useEffect(() => {
    setNote("Max file size limit: 5MB.")
    if (initialData) setImageUrls(initialData.images.map((image) => image.url))
    else setImageUrls([])
  }, [initialData, setImageUrls, setNote])
